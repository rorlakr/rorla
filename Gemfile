...
gem 'merit', '3.0.1'
# https://stackoverflow.com/a/48710824
...
gem 'redcarpet', '3.4.0'
# Remotipart is a Ruby on Rails gem enabling remote multipart forms (AJAX style file uploads) with jquery-rails. (http://opensource.alfajango.com/remotipart/)
