...
gem 'rolify'
# Authority helps you authorize actions in your Rails app using plain Ruby methods on Authorizer classes. (https://github.com/nathanl/authority)
gem 'authority'
...
# Integrates the Twitter Bootstrap pagination component with will_paginate (https://github.com/bootstrap-ruby/will_paginate-bootstrap)
...
group :development, :test do
  # rspec-rails-2.14.2 (http://github.com/rspec/rspec-rails)
...
group :test do
  # Easily generate fake data (http://faker.rubyforge.org)
  gem "faker", "~> 1.1.2"
  ...
  gem 'capybara-webkit'
  # Strategies for cleaning databases.  Can be used to ensure a clean state for testing. (http://github.com/bmabey/database_cleaner)
  ...
  gem "launchy", "~> 2.4.2"
  # The next generation developer focused tool for automated testing of webapps (http://selenium.googlecode.com)
